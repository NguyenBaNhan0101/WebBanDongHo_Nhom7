					...
					<div class="product well">
						...
						<div class="col-md-9">
							<div class="caption">
								...
								<div>
									<input type="submit" action="updatecart.php" name="update" style="margin-top:31px"  value="Cập nhật" class="btn btn-2" />
								</div>
								<hr>
			...
			<a href="removeallcart.php" class="btn btn-2" style="margin-bottom:31px">Xóa hết giỏ hàng</a>
				<div class="col-md-4 col-md-offset-8 ">
					<center>
                        ...
                        <a href="index.php" class="btn btn-1" style="margin-left:-76px">Chọn thêm sản phẩm khác</a>
                    </center>
				</div>
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8" >
						...
						<center><a href="account.php"  class="btn btn-1">Vui lòng đăng nhập</a></center>
					</div>
				</div>
			</div>
		</div> 
